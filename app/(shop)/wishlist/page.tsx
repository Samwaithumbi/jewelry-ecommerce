...
import { Share2, ShoppingBag, Lock } from "lucide-react"
      ...
      <div className="min-h-screen bg-[#FAF9F6] pb-24">
        <div className="mx-auto max-w-7xl px-4 md:px-8 pt-8">
          <div className="flex flex-col items-center justify-center py-32 text-center gap-4">
            ...
            <h2 className="text-xl font-semibold text-[#111827]">Sign in to view your wishlist</h2>
            <p className="text-muted-foreground text-sm max-w-xs">
              Save your favorite pieces and access them anytime by signing in to your account.
            </p>
            <a
              href="/sign_in?callbackUrl=/wishlist"
